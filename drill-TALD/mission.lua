...
-- Menus BVR
local MenuSEADBlue = MENU_COALITION:New( coalition.side.BLUE, "SEAD/DEAD" )
menuactivateSAM = MENU_COALITION_COMMAND:New( coalition.side.BLUE, "Activer site SAM", MenuSEADBlue, fctActivateSAM, { "SA10"} )
menudeactivateSAM = MENU_COALITION_COMMAND:New( coalition.side.BLUE, "Désactiver site SAM", MenuSEADBlue, fctSuspendSAM, { "SA10"} )
menupopsu27 = MENU_COALITION_COMMAND:New( coalition.side.BLUE, "Lancement Intercepteurs RED", MenuSEADBlue, ActivateGroup, { spawnsu27, "Excellent", "Maykop Défense", 45} )
menuKillInterceptors = MENU_COALITION_COMMAND:New( coalition.side.BLUE, "sweep Intercepteurs RED", MenuSEADBlue, fctKillSpawnObjectArray, { { spawnsu27}, "Zone SEAD dégagée !!"})
