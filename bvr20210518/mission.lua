...
-- Spawns Tankers
--
spawn200 = SPAWN:New("BVRSU27")
spawn203 = SPAWN:New("BVRMIG21")
spawn402 = SPAWN:New("BVRMIG29")
...
menupop402 = MENU_COALITION_COMMAND:New( coalition.side.BLUE, "popup BVR Mig29", MenuBVRBlue, ActivateGroup, {spawn402, "Excellent", "Mig29", 45} )
menuKillAllBVRPlanes = MENU_COALITION_COMMAND:New( coalition.side.BLUE, "sweep de la zone BVR", MenuBVRBlue, fctKillSpawnObjectArray, {{spawn200, spawn203, spawn402}, "Zone BVR d�gag�e !!"})
